...
from app.routes import auth, reports, appointments, doctors, notifications
...
app = FastAPI(
    ...
    description="Backend API for MediVision AI Platform with SIH1383 Smart Appointment Allocation",
    version="2.0.0"
)
