      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm md:col-span-2">
          ...
          <div className="flex flex-col gap-3 mt-4">
            <div className="bg-red-50 border border-red-100 px-4 py-3 rounded-xl flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-500 shrink-0 mt-0.5" />
              <div>
                <p className="text-sm font-bold text-red-800">Spiculated Nodule (Left Lower Lobe)</p>
                <p className="text-xs text-red-700 mt-1">Confidence: 94%. High probability of malignancy. Immediate follow-up with pulmonology or oncology is strongly recommended.</p>
              </div>
            </div>
          </div>
        </div>
