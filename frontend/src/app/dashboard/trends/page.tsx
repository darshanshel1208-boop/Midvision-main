    ...
    <div className="max-w-6xl mx-auto space-y-8 p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1">AI-driven parameter tracking across blood tests, vitals, and reports.</p>
        </div>
            ...
            {selectedMetric.status === 'borderline' && (
              <div className="mt-4 p-4 bg-amber-50 rounded-2xl border border-amber-100 text-xs text-amber-900 space-y-2">
                ...
                <p className="text-[11px] leading-relaxed">
                  Based on clinical protocol, longitudinal drifts above baseline threshold benefit from preventive specialist consultation.
                </p>
              </div>
            )}
          </div>
