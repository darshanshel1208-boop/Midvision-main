...
import '../landing.css';
import { Mail, Lock, CheckCircle2, Loader2, User } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="landing-page relative min-h-screen">
      ...
      {/* Glassmorphism Register Overlay */}
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4 pointer-events-none">
        ...
        <div className="w-full max-w-md bg-white/20 backdrop-blur-2xl border border-white/50 rounded-3xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.1)] flex flex-col items-center pointer-events-auto">
          ...
          <div className="w-full mt-2">
            <h2 className="text-xl font-bold text-slate-800 text-center mb-1">Create an Account</h2>
            <p className="text-slate-500 text-sm text-center mb-6">Join the future of healthcare</p>
            ...
            <form onSubmit={handleRegister} className="space-y-4 w-full">
              ...
              <div className="mt-4 flex items-center justify-center gap-2">
                ...
                <Link href="/login" className="text-xs font-semibold text-blue-600 hover:text-blue-700">Login</Link>
              </div>
            </form>
          </div>
